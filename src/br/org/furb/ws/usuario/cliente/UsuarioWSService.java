 ...
 * 
 */
@WebServiceClient(name = "UsuarioWSService", targetNamespace = "http://usuario.ws.furb.org.br/", wsdlLocation = "http://192.168.25.11/usuario?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.25.11/usuario?wsdl");
